...
<div id='uyari' class="conteiner-fluid"
	style='z-index:20000; margin: 0px; padding: 0px; align: center; border-radius: 5px; text-align: center; top: 50%; box-sizing: border-box; left: 50%; border: 2px groove #ff9900; font-size: 20px; display: inline; position: fixed; background-color: white; -ms-transform:translateZ(10px);transform: translate(12px, 50%); -webkit-transform: translate(-50%, -50%); opacity: 1; filter: alpha(opacity = 90); width: 100%; height: 100%;'>
	<div
		...
		<form:form action="login" method="post" commandName="kullanici" autocomplete="off">
			<form:hidden path="id" />
			<table class="table">
				<tr>
